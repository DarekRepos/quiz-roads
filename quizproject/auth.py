...
def signup():
    ...
    if form.validate_on_submit():
        ...
        new_user = User(user_email=form.email.data, user_name=form.username.data, user_password=generate_password_hash(form.password.data, method='sha256'),register_time=register_time)
